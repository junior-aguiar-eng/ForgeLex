  ...
  return (
    <div className="py-8 md:py-12">
      <div className="page-container space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-champagne-border pb-6">
          <div>
            ...
            <p className="text-sm text-stone-500 mt-1">
              Configure os modelos disponíveis para apoiar sua pesquisa e seus rascunhos.
            </p>
          </div>
        ...
        <div className="champagne-card min-w-0 space-y-4 rounded-xl border-cognac-300 bg-gradient-to-br from-white via-[#FAF8F2] to-[#F5EFE6] p-5 sm:p-6">
          <div className="flex min-w-0 flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex min-w-0 flex-wrap items-center gap-2">
              <div className="min-w-0 max-w-full break-all rounded-xl border border-champagne-border bg-white px-3 py-2.5 font-mono text-xs text-stone-800 select-all shadow-sm">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-stone-500 border-t border-stone-200/60">
            ...
            <span>•</span>
            <span>Ferramentas disponíveis para integrações externas</span>
            <span>•</span>
        ...
        <div className="champagne-card p-6 sm:p-8 rounded-2xl bg-white shadow-card space-y-5">
          <div className="flex items-center justify-between border-b border-stone-100 pb-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-editorial text-lg font-bold text-stone-900">
                Ambiente de teste de inferência
              </h3>
            </div>
