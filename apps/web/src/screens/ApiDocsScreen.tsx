...
export const ApiDocsScreen: React.FC = () => {
  ...
  return <div className="py-8 md:py-12"><div className="page-container space-y-8">
    ...
    <section className="surface-subtle space-y-2 p-5 text-sm text-stone-600"><h2 className="font-editorial text-lg font-bold text-stone-800">Autenticação e limites</h2><p>As rotas protegidas usam credencial Bearer e os escopos definidos pelo ambiente. A cobrança e os limites devem ser consultados no contrato efetivamente publicado; esta tela não presume valores, permissões ou credenciais de produção.</p></section>
  </div></div>;
};
