...
export const ApiDocsScreen: React.FC = () => {
  ...
  return <div className="py-8 md:py-12"><div className="page-container space-y-8">
    ...
    <section className="surface-subtle space-y-2 p-5 text-sm text-stone-600"><h2 className="font-editorial text-lg font-bold text-stone-800">Autenticação, cobrança e privacidade</h2><p>As rotas protegidas usam API key ou credencial Bearer e os escopos definidos pelo ambiente. Os créditos ForgeLex pagam as operações jurídicas da API/MCP, inicialmente R$ 0,20 por busca jurisprudencial; não há cobrança de tokens. O MCP não acessa conversas, arquivos ou histórico do host.</p></section>
  </div></div>;
};
