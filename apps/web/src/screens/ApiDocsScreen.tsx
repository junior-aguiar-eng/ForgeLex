...
export const ApiDocsScreen: React.FC = () => {
  ...
  return <div className="py-8 md:py-12"><div className="page-container space-y-8">
    <div className="border-b border-champagne-border pb-6"><p className="eyebrow">Área demonstrativa e técnica</p><h1 className="font-editorial text-3xl font-bold text-stone-900 sm:text-4xl">Documentação da API</h1><p className="mt-1 max-w-3xl text-sm leading-relaxed text-stone-500">A API REST e o MCP são dois canais para a mesma infraestrutura jurisprudencial. O ForgeLex fornece dados, ferramentas e proveniência; o modelo usado no ChatGPT, Claude ou no seu software pertence à integração do cliente.</p></div>
